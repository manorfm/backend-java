...
public class ClockControllerTest {
	...
	private List<Clock> getCenario1Clocks() {
	...
	private List<Clock> getCenario2Clocks() {
		return Arrays.asList(new Clock(null, LocalDateTime.of(2018, 4, 4, 8, 30)));
	}
	...
	private List<Clock> getCenario3Clocks() {
		List<Clock> clock = new ArrayList<>();
		...
		clock.add(new Clock(null, LocalDateTime.of(2018, 4, 5, 15, 30, 45)));
		clock.add(new Clock(null, LocalDateTime.of(2018, 4, 5, 19, 40, 45)));
		clock.add(new Clock(null, LocalDateTime.of(2018, 4, 5, 20, 25, 11)));
		clock.add(new Clock(null, LocalDateTime.of(2018, 4, 5, 23, 45, 11)));
